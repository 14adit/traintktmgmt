...
function Front() {
  return(
    <div className=''>
      <Navbar />
    <div className="text-white pt-8 size-full bg-scroll bg-cover bg-" style={{backgroundImage:"url(/Trainplatform.jpg)"}}>
        <div className='pb-20'>
           ...
           <Link to="/create-ticket" class="focus:outline-none text-black bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-bold rounded-full text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900 mt-8 ml-72 h-12 w-auto">Start</Link>
        </div>
